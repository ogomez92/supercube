...
class Strings {
	constructor() {
		...
		this.strings[1] = {
			// New English
			reviewCube: "Round %1. Level %2 of %3. Use the arrow keys to review this cube, and enter when you are done. The space bar repeats the top value",
